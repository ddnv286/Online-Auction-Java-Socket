	...
	public void refresh() throws Exception
	{
		...
		if(status && !flag)
		{
			...
			while(it.hasNext())
			{
				sentitem=it.next();
				Barray=sentitem.b;
				File file=new File("F:\\Software\\eclipse\\projects\\Online Auction\\Customer\\CustomerImages\\"+String.valueOf(sentitem.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\Customer\\CustomerImages\\"+String.valueOf(sentitem.ID)+".txt");
