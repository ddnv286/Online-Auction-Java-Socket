...
public class Login extends JFrame {
	...
	public Login() throws UnknownHostException, IOException {
		...
		label2 = new JLabel("ONLINE AUCTION LOGIN");
		label2.setForeground(Color.WHITE);
		label2.setFont(new Font("Dialog", Font.BOLD, 25));
		label2.setBounds(469, 79, 354, 60);
		contentPane.add(label2);

		icon2 = new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\login.jpg");
		...
		lblNewLabel.setIcon(new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\Login2.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\User5.png"));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\pwd3.png"));
