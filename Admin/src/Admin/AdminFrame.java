...
public class AdminFrame extends JFrame {
	...
	public JLabel label_1, lblYouCanSell, lblWillStartAt, label, lblOnlineAuction, lblJashinVD, label3, lblCustomer;
	...
	public AdminFrame(AdminLogin parent, ObjectInputStream input, ObjectOutputStream output) throws Exception {
		...
		icon = new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\index.png");
		...
		icon2 = new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\Frame2.jpg");
		...
		icon4 = new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\a1.jpg");
		...
		icon3 = new ImageIcon("F:\\Software\\eclipse\\projects\\Online Auction\\ProjectImages\\logo.png");
		...
		btnNewButton.setBounds(0, 57, 300, 60);
...
//				customerlist.refresh();
		...
		lblOnlineAuction = new JLabel("Online Auction");
		lblOnlineAuction.setHorizontalAlignment(SwingConstants.CENTER);
		lblOnlineAuction.setForeground(Color.BLUE);
		lblOnlineAuction.setBounds(590, 25, 340, 35);
		lblOnlineAuction.setFont(new Font("Dialog", Font.BOLD, 35));
		contentPane.add(lblOnlineAuction);

		lblJashinVD = new JLabel("JashinVD.Ltd.");
		lblJashinVD.setForeground(Color.BLUE);
		lblJashinVD.setBounds(858, 58, 70, 15);
		contentPane.add(lblJashinVD);
